...
export const unpack = unpackAll.unpack = function (archiveFile, options, callback) {
...
export const unpackonly = unpackAll.unpackonly = function (archiveFile, unpackDir, unpackOnly, callback) {
    if (!callback) return new Error('No callback function');
...
export const list = unpackAll.list = function (archiveFile, options, callback) {
    if (!callback) return new Error('No callback function');
    if (!archiveFile) archiveFile = options.archiveFile;
    if (!archiveFile) return callback(Error("Error: archiveFile or options.archiveFile missing."), null);
